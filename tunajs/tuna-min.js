(function () {
	...
	Tuna.prototype.Bitcrusher = function (properties) {
		...
		this.processor.onaudioprocess = function (e) {
			...
			for (i = 0; i < length; i++) {
				...
				if (phaser >= 1) {
					phaser -= 1;
					last = step * Math.floor(input[i] / step + .5)
				}
				output[i] = last
			}
		};
	...
	Tuna.prototype.Cabinet.prototype = Object.create(Super, {
		...
		makeupGain: {
			...
			set: function (value) {
				this.makeupNode.gain.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		newConvolver: {
	...
	Tuna.prototype.Chorus.prototype = Object.create(Super, {
		...
		feedback: {
			...
			set: function (value) {
				...
				this.feedbackGainNodeLR.gain.setTargetAtTime(this._feedback, userContext.currentTime, .01);
				this.feedbackGainNodeRL.gain.setTargetAtTime(this._feedback, userContext.currentTime, .01)
			}
		},
		rate: {
			enumerable: true,
	...
	Tuna.prototype.Compressor.prototype = Object.create(Super, {
		...
		makeupGain: {
			...
			set: function (value) {
				this.makeupNode.gain.setTargetAtTime(dbToWAVolume(value), userContext.currentTime, .01)
			}
		}
	});
	...
	Tuna.prototype.Convolver.prototype = Object.create(Super, {
		...
		lowCut: {
			...
			set: function (value) {
				this.filterLow.frequency.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		highCut: {
			get: function () {
			...
			set: function (value) {
				this.filterHigh.frequency.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		level: {
			get: function () {
			...
			set: function (value) {
				this.output.gain.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		dryLevel: {
			get: function () {
			...
			set: function (value) {
				this.dry.gain.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		wetLevel: {
			get: function () {
			...
			set: function (value) {
				this.wet.gain.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		buffer: {
			enumerable: false,
	...
	Tuna.prototype.Delay.prototype = Object.create(Super, {
		...
		feedback: {
			...
			set: function (value) {
				this.feedbackNode.gain.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		cutoff: {
			enumerable: true,
			...
			set: function (value) {
				this.filter.frequency.setTargetAtTime(value, userContext.currentTime, .01)
			}
		}
	});
	...
	Tuna.prototype.Filter.prototype = Object.create(Super, {
		...
		gain: {
			...
			set: function (value) {
				this.filter.gain.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		frequency: {
			enumerable: true,
	...
	Tuna.prototype.Gain.prototype = Object.create(Super, {
		...
		gain: {
			...
			set: function (value) {
				this.gainNode.gain.setTargetAtTime(value, userContext.currentTime, .01)
			}
		}
	});
	Tuna.prototype.MoogFilter = function (properties) {
		...
		this.processor.onaudioprocess = function (e) {
			...
			f = this.cutoff * 1.16;
			inputFactor = .35013 * (f * f) * (f * f);
			fb = this.resonance * (1 - .15 * f * f);
			length = input.length;
			for (i = 0; i < length; i++) {
				input[i] -= out4 * fb;
				input[i] *= inputFactor;
				out1 = input[i] + .3 * in1 + (1 - f) * out1;
				in1 = input[i];
				out2 = out1 + .3 * in2 + (1 - f) * out2;
				in2 = out1;
				out3 = out2 + .3 * in3 + (1 - f) * out3;
				in3 = out2;
				out4 = out3 + .3 * in4 + (1 - f) * out4;
				in4 = out3;
				output[i] = out4
			}
		};
	...
	Tuna.prototype.Overdrive.prototype = Object.create(Super, {
		...
		outputGain: {
			...
			set: function (value) {
				...
				this.outputDrive.gain.setValueAtTime(this._outputGain, userContext.currentTime, .01)
			}
		},
		algorithmIndex: {
			get: function () {
		...
		waveshaperAlgorithms: {
			value: [function (amount, n_samples, ws_table) {
				...
				for (i = 0; i < n_samples; i++) {
					x = i * 2 / n_samples - 1;
					if (x < -.08905) {
						ws_table[i] = -3 / 4 * (1 - Math.pow(1 - (Math.abs(x) - .032857), 12) + 1 / 3 * (Math.abs(x) - .032847)) + .01
	...
	Tuna.prototype.Phaser.prototype = Object.create(Super, {
		...
		feedback: {
			...
			set: function (value) {
				this._feedback = value;
				this.feedbackGainNodeL.gain.setTargetAtTime(this._feedback, userContext.currentTime, .01);
				this.feedbackGainNodeR.gain.setTargetAtTime(this._feedback, userContext.currentTime, .01)
			}
		},
		stereoPhase: {
			get: function () {
	...
	Tuna.prototype.PingPongDelay.prototype = Object.create(Super, {
		...
		feedback: {
			...
			set: function (value) {
				this.feedbackLevel.gain.setTargetAtTime(value, userContext.currentTime, .01)
			}
		},
		defaults: {
			writable: true,
